...
const banner2 = cfonts.render((`LUIX
BOT-V10`), {
font: 'block',             
align: 'center',           
color: 'candy',
...
*/const banner2 = cfonts.render((`Canal: https://youtube.com/@luix1397\nDesenvolvedor Oficial: @Luix1397`), {
font: 'console',
align: 'center',
...
authorname = 'LUIX-BOT-8.5'
packname = '-LX-'
  
function addMetadata(packname, author) {	
if (!packname) packname = '-JR-'; if (!author) author = 'LUIX-BOT-8.5';	
...
chyt = `555584656478@s.whatsapp.net`
...
module.exports = { start2, getBuffer, h2k, generateMessageID, getGroupAdmins, getRandom, start, infopd, success, banner2, close, addATM, addKoinUser, checkATMuser, temporizador, color, recognize, bgcolor, cmdadd, isFiltered, addFilter, addLimit, getLimit, addMetadata, chyt, getExtension}
